...
class Agent:
    ...
    def verified_delivery(self) -> "VerifiedDelivery":
        """Return a VerifiedDelivery orchestrator bound to this agent.

        Enables graph-verified code delivery using Graphify knowledge graphs.
        Requires: pip install nexus-ledger[graphify]
        """
        from .graphify_bridge import VerifiedDelivery
        return VerifiedDelivery(self)
